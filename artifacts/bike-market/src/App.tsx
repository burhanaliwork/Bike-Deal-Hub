...
const clerkAppearance = {
  ...
  variables: {
    colorPrimary: "hsl(213, 88%, 50%)",
    colorForeground: "hsl(220, 30%, 10%)",
    colorMutedForeground: "hsl(213, 10%, 48%)",
    colorDanger: "hsl(0, 84%, 60%)",
    colorBackground: "hsl(0, 0%, 100%)",
    colorInput: "hsl(213, 20%, 95%)",
    colorInputForeground: "hsl(220, 30%, 10%)",
    colorNeutral: "hsl(213, 20%, 88%)",
  ...
  elements: {
    ...
    formFieldInput: "border-gray-200 bg-gray-50 focus:border-blue-400",
